...
describe("Category API - Delete category", () => {
    test("Deleting a category works", async () => {
        ...
        const deleteCategoryResponse = await api.delete(`/api/manage/categories/${categoryId}`)
        assert.strictEqual(deleteCategoryResponse.body.category_name, "Joonaksen salimaksimit")
